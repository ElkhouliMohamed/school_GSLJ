            ...
            <div className="relative isolate overflow-hidden bg-violet-950 py-24 sm:py-32">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <div
                            className="mt-6 text-xl leading-8 !text-white [&_*:not(a)]:!text-white tinymce-content"
            ...
            <div className="bg-gray-50 py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-6">
                        {settings.registration_pdf?.en && (
                            <a
                                href={settings.registration_pdf.en}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-sm font-semibold leading-6 text-violet-600 hover:text-violet-500 transition-colors flex items-center gap-2"
                            >
                        ...
                        {settings.rules_pdf?.en && (
                            <a
                                href={settings.rules_pdf.en}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-sm font-semibold leading-6 text-violet-600 hover:text-violet-500 transition-colors flex items-center gap-2"
                            >
