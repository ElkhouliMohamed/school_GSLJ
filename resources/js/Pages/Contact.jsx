                        ...
                        <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg bg-white shadow-2xl rounded-2xl p-8 sm:p-10 border border-gray-200">
                            ...
                            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <div className="mt-2.5 bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-violet-600 overflow-hidden">
                                        <Editor
                                        ...
                                        />
                                        {errors.message && <div className="text-red-600 text-sm mt-1 px-3.5 pb-2">{errors.message}</div>}
                                    </div>
                                </div>
                            </div>
