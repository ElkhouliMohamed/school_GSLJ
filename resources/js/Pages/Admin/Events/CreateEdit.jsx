...
export default function CreateEdit({ event = null }) {
    ...
    const submit = (e) => {
        ...
        const routeName = isEditing
            ? route('admin.events.update', event.id, false)
            : route('admin.events.store', undefined, false);
        ...
        <AdminLayout title={isEditing ? 'Edit Event' : 'Create Event'}>
            ...
            <form onSubmit={submit} className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                ...
                <div className="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                    <Link href={route('admin.events.index', undefined, false)} className="text-sm font-semibold leading-6 text-gray-900">
                        Cancel
                    </Link>
                    <button
                        type="submit"
