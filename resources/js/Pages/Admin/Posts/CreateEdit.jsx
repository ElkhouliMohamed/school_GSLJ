...
export default function CreateEdit({ post = null }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        const routeName = isEditing ? route('admin.posts.update', post.id) : route('admin.posts.store');
    ...
    return (
        <AdminLayout title={isEditing ? 'Edit Post' : 'Create Post'}>
            ...
            <form onSubmit={submit} className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                ...
                <div className="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                    <Link href={route('admin.posts.index')} className="text-sm font-semibold leading-6 text-gray-900">
                        Cancel
                    </Link>
                    <button
                        type="submit"
