                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <div className="flex items-center">
                            <div className="h-8 w-8 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold mr-2 text-xl">
                                {siteName.charAt(0)}
                            </div>
                            <span className="text-white font-bold text-xl tracking-tight">{siteName}</span>
                        </div>
                        <p className="text-sm leading-6 text-gray-300">
                            Promouvoir l'excellence éducative et le développement du caractère de nos élèves depuis 2010.
                        </p>
                        <div className="flex space-x-6">
                            {fbUrl && (
                                <a href={fbUrl} className="text-gray-400 hover:text-white transition-colors">
                            ...
                            {instaUrl && (
                                <a href={instaUrl} className="text-gray-400 hover:text-white transition-colors">
                    ...
                    <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-10 md:mt-0">
                                ...
                                <ul role="list" className="mt-6 space-y-4">
                                    <li className="text-sm leading-6 text-gray-300">123 Avenue de l'Excellence, Casablanca</li>
