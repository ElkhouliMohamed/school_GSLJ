...
export default function NewsletterSection() {
    ...
    return (
        <section className="bg-violet-600 py-16 sm:py-24">
                        ...
                        <div className="mt-6 flex max-w-md gap-x-4">
                            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 w-full">
                                ...
                                <input
                                    ...
                                    className="min-w-0 flex-auto rounded-md border-0 bg-white/10 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/20 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6 placeholder:text-violet-200"
                                    placeholder={locale === 'en' ? 'Enter your email' : 'Entrez votre email'}
                                />
                                <button
                                    type="submit"
                                    disabled={status === 'loading' || status === 'success'}
                                    className={`flex-none rounded-md px-3.5 py-2.5 text-sm font-semibold shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-all ${status === 'success'
